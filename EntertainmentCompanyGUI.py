...
class EntertainmentCompanyGUI:
    ...
    def setup_buttons(self):
        ...
        for i, text in enumerate(entertainment_company_button_texts):
            button = tk.Button(self.master, text=text, command=entertainment_company_button_commands[i])
    ...
    def add_entertainment_company(self):
        ...
        try:
            existing_entertainment_companies = FileHandler.load_data("entertainment_companies_data.pkl")
        ...
        FileHandler.save_data(existing_entertainment_companies, "entertainment_companies_data.pkl")
