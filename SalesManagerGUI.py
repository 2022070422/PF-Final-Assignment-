...
class SalesManagerGUI:
    ...
    def setup_buttons(self):
        ...
        for i, text in enumerate(sales_manager_button_texts):
            button = tk.Button(self.master, text=text, command=sales_manager_button_commands[i])
    ...
    def add_sales_manager(self):
        ...
        try:
            existing_sales_managers = FileHandler.load_data("sales_managers_data.pkl")
        ...
        FileHandler.save_data(existing_sales_managers, "sales_managers_data.pkl")
